...
if induction_effect:
	figFileName = 'power_induction.png'
	tab_data_file = 'power_induction.csv'
...
if grid_effect:
	figFileName = 'power_grid_effect.png'
	tab_data_file = 'power_grid_effect.csv'
...
if epsilon_effect:
	figFileName = 'power_gaussian_effect.png'
	tab_data_file = 'power_gaussian_effect.csv'
	plt_title   = '$Grid: \Delta x = \Delta y = 4 m, \Delta z = 4 ; Induction: Glauert, a_{n} = 0.02, a_{t} = iterated $'
...
ind1_for_tab = 4 # To be used in the paper
ind2_for_tab = 5 # To be used in the paper
...
for case in case_keys:
    ...
    for ind_vhub, ws_hub in enumerate(vhub):
        case_for_ws = path.join(case, 'power_curve_{}'.format(ws_hub))
    ...
    power1_tab.append(power_case_ws[ind1_for_tab])
    power2_tab.append(power_case_ws[ind2_for_tab])
    error1_tab.append(error_NREL[ind1_for_tab])
    error2_tab.append(error_NREL[ind2_for_tab])
