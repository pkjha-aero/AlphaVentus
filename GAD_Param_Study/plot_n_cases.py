...
os.system('mkdir -p %s'%GAD_param_output_loc)
...
if induction_effect:
	figFileName = os.path.join(GAD_param_output_loc, 'power_induction.png')
	tab_data_file = os.path.join(GAD_param_output_loc, 'power_induction.csv')
...
if grid_effect:
	figFileName = os.path.join(GAD_param_output_loc, 'power_grid_effect.png')
	tab_data_file = os.path.join(GAD_param_output_loc, 'power_grid_effect.csv')
...
if epsilon_effect:
	figFileName = os.path.join(GAD_param_output_loc, 'power_gaussian_effect.png')
	tab_data_file = os.path.join(GAD_param_output_loc, 'power_gaussian_effect.csv')
